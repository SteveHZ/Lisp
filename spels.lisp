...
(defvar *map* '((living-room (you are in the living-room of a wizards house. there is a wizard snoring loudly on the couch.)
              ...
              (attic (you are in the attic of the wizards house. there is a giantwelding torch in the corner.)
...
(game-action dunk bucket well garden
             (cond (*chain-welded* (setf *bucket-filled* 't)
