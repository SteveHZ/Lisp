...
(defmacro defseries (fn-name games-fn result-fn odds-fn)
  `(defun ,fn-name (series &optional (n 10))
	 (series-table n (do-series series ,games-fn ,result-fn ,odds-fn))))

(defseries do-series-wins #'home-aways #'home-away-win-result #'home-away-odds )
(defseries do-series-home-wins #'homes #'home-away-win-result #'home-away-odds)
(defseries do-series-away-wins #'aways #'home-away-win-result #'home-away-odds)

(defseries do-series-defeats #'home-aways #'home-away-defeat-result #'home-away-lost-odds)
(defseries do-series-home-defeats #'homes #'home-away-defeat-result #'home-away-lost-odds)
(defseries do-series-away-defeats #'aways #'home-away-defeat-result #'home-away-lost-odds)

(defseries do-series-draws #'home-aways #'home-away-draw-result #'series-draw-odds)
(defseries do-series-home-draws #'homes #'home-away-draw-result #'series-draw-odds)
(defseries do-series-away-draws #'aways #'home-away-draw-result #'series-draw-odds)

(defseries do-series-overs #'home-aways #'series-overs #'series-over-odds)
(defseries do-series-home-overs #'homes #'series-overs #'series-over-odds)
(defseries do-series-away-overs #'aways #'series-overs #'series-over-odds)

(defseries do-series-unders #'home-aways #'series-unders #'series-under-odds)
(defseries do-series-home-unders #'homes #'series-unders #'series-under-odds)
(defseries do-series-away-unders #'aways #'series-unders #'series-under-odds)

(defseries do-series-last-six-overs #'last-six #'series-overs #'series-over-odds)
(defseries do-series-last-six-unders #'last-six #'series-unders #'series-under-odds)

(defmacro doseries-calc (fn-name games-fn result-fn odds-fn)
  `(defun ,fn-name (series)
	 (do-series series ,games-fn ,result-fn ,odds-fn)))

(doseries-calc new-do-series-wins-calc #'home-aways #'home-away-win-result #'home-away-odds)